...
export function buildSystemPrompt({ settings, agendaCompact, emailActionCompact }) {
  ...
  return (
    ...
    `(triados em AÇÃO/INFO/RUÍDO), RADAR DE NOTÍCIAS, MORNING DIGEST e PROSPECÇÃO DE CLIENTES (busca diária de ` +
    `negócios locais qualificados como leads, com telefone e endereço). Se perguntarem o que você sabe fazer, ` +
